...
*   [Comment puis-je reprendre le controle de mon serveur si MCSS plante ?](#regain-control)
...
<span style="color:red">ATTENTION: Cela va terminer tous les processus Java, pas seulement les serveurs Minecraft hébergés par MCSS.
Cela inclut : 
